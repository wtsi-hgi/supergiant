...
type EntrypointListener struct {
	...
	EntrypointName string      `json:"entrypoint_name" validate:"nonzero" gorm:"not null;index;unique_index:entrypoint_port;unique_index:port_name_within_entrypoint"`
	...
	Name string `json:"name" validate:"nonzero,max=24,regexp=^[a-z]([-a-z0-9]*[a-z0-9])?$" gorm:"not null;index;unique_index:port_name_within_entrypoint"`
