...
func (p *AWSProvider) ValidateAccount(m *models.CloudAccount) error {
	_, err := p.ec2("us-east-1").DescribeKeyPairs(new(ec2.DescribeKeyPairsInput))
	return err
}

func (p *AWSProvider) CreateKube(m *models.Kube, action *Action) error {
...
func (p *AWSProvider) DeleteKube(m *models.Kube) error {
	ec2S := p.ec2(m.AWSConfig.Region)
	provisioner := &provisioner{core: p.core, kube: m}
...
func (p *AWSProvider) CreateNode(m *models.Node, action *Action) error {
...
func (p *AWSProvider) DeleteNode(m *models.Node) error {
	return p.deleteServer(m)
}

func (p *AWSProvider) CreateVolume(m *models.Volume, action *Action) error {
	return p.createVolume(m, nil)
}

func (p *AWSProvider) ResizeVolume(m *models.Volume, action *Action) error {
...
func (p *AWSProvider) WaitForVolumeAvailable(m *models.Volume, action *Action) error {
	return p.waitForAvailable(m)
}

func (p *AWSProvider) DeleteVolume(m *models.Volume) error {
	return p.deleteVolume(m)
}

func (p *AWSProvider) CreateEntrypoint(m *models.Entrypoint, action *Action) error {
	return p.createELB(m)
}

func (p *AWSProvider) AddPortToEntrypoint(m *models.Entrypoint, lbPort int64, nodePort int64) error {
...
func (p *AWSProvider) RemovePortFromEntrypoint(m *models.Entrypoint, lbPort int64) error {
...
func (p *AWSProvider) DeleteEntrypoint(m *models.Entrypoint) error {
...
func (p *AWSProvider) awsConfig(region string) *aws.Config {
...
func (p *AWSProvider) ec2(region string) *ec2.EC2 {
	return ec2.New(globalAWSSession, p.awsConfig(region))
}

func (p *AWSProvider) iam(region string) *iam.IAM {
	return iam.New(globalAWSSession, p.awsConfig(region))
}

func (p *AWSProvider) elb(region string) *elb.ELB {
	return elb.New(globalAWSSession, p.awsConfig(region))
}

//------------------------------------------------------------------------------

func (p *AWSProvider) servers(m *models.Kube) (instances []*ec2.Instance, err error) {
...
func (p *AWSProvider) server(m *models.Kube, id string) (*ec2.Instance, error) {
...
func (p *AWSProvider) filteredServers(m *models.Kube, filters map[string][]string) (instances []*ec2.Instance, err error) {
...
func (p *AWSProvider) setAttrsFromServer(m *models.Node, server *ec2.Instance) {
...
func (p *AWSProvider) createServer(m *models.Node) (*ec2.Instance, error) {
...
func (p *AWSProvider) deleteServer(m *models.Node) error {
...
func (p *AWSProvider) createELB(m *models.Entrypoint) error {
...
func (p *AWSProvider) registerNodes(m *models.Entrypoint, nodes ...*models.Node) error {
...
func (p *AWSProvider) deleteELB(m *models.Entrypoint) error {
	// Delete ELB
...
func (p *AWSProvider) createVolume(volume *models.Volume, snapshotID *string) error {
...
func (p *AWSProvider) deleteVolume(volume *models.Volume) error {
...
func (p *AWSProvider) waitForAvailable(volume *models.Volume) error {
...
func (p *AWSProvider) forceDetachVolume(volume *models.Volume) error {
...
func (p *AWSProvider) createSnapshot(volume *models.Volume) (*ec2.Snapshot, error) {
...
func (p *AWSProvider) deleteSnapshot(volume *models.Volume, snapshot *ec2.Snapshot) error {
